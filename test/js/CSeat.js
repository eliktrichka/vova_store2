function CSeat(){
    ...
    this._init = function(){
        ...
        var oBg = new createjs.Bitmap(s_oSpriteLibrary.getSprite('seat'));
        oBg.x = 66;
        oBg.y = 175;
        ...
        _oArrowCurPlayer = new createjs.Bitmap(s_oSpriteLibrary.getSprite('arrow_hand'));
