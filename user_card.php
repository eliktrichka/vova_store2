...
<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
    <div class="container-fluid">
        ...
        <div class="inner-sec-shop px-lg-4 px-3">
            ...
            <h3 class="tittle-w3layouts text-center my-lg-4 my-3">PAGE <?PHP print_r($_SESSION['login']) ?></h3>
            <!---728x90--->
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="customer-info text-left py-lg-4 py-2">
                                <h4><?PHP print_r($_SESSION['login'])?></h4>
                                <h6>THIS SITE</h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-9 customer-main">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="registration_exchange.php" method="POST">
                                <div class="form-group">
                                    <label class="mb-2">NAME</label>
                                    <input type="text" name="exampleproduct_name" class="form-control" id="exampleproduct_name" aria-describedby="emailHelp" placeholder="" required="required">
                                </div>
<!--                                <div class="form-group">-->
